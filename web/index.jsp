...
<%-- send info tosearchservlet !!!!!!!!!!!!!!!!!!!!! --%>
            ...
            <div class="featured-teaser-text">
              ...
              <%
                ...
                out.print("<p>We had <strong style=\"color:#8bcf17;\"> "+ tmpUserdao.getUserNomber() +"</strong> users who use our site</p>");
                out.print("<p>We had <strong style=\"color:#8bcf17;\"> "+ tmpTripdao.getTripNumber() +"</strong> trips between campus </p>");
              %>
              <p></p>
